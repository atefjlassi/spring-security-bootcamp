package spring.sec.bootcamp.e11.authserver.entities;
...
public class Client {
  ...
  public static RegisteredClient from(Client client) {
    return RegisteredClient.withId(String.valueOf(client.getId()))
      ...
      .scope(client.getScope()).redirectUri(client.getRedirectUri())
      .clientAuthenticationMethod(new ClientAuthenticationMethod(client.getAuthMethod()))
      .authorizationGrantType(new AuthorizationGrantType(client.getGrantType())) //from db, value= authorization_code
      .authorizationGrantType(AuthorizationGrantType.CLIENT_CREDENTIALS) // for the service client
